 ...
 */
Configure::write('TrelloApi.key', 'your trello api key here');

/**
 * Application secret
 * @link https://trello.com/1/appKey/generate
 */
Configure::write('TrelloApi.secret', 'your trello api secret key here');
...
/**
 * OAuth access callback URL
 */
Configure::write('TrelloApi.callBackUri', 'https://localhost/rfc4trello/api');
